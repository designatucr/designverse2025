  ...
  return (
    <div className="relative">
      ...
      <Image
        src={Bubble2}
        alt="Bubble"
        className="absolute left-[73%] top-[8%] h-4 w-4 lg:left-[28%] lg:top-[10%] lg:h-8 lg:w-8"
      />
      <Image
        src={Bubble}
        alt="Bubble"
        className="absolute left-[80%] top-[10%] h-8 w-8 lg:left-[30%] lg:top-[13%] lg:h-14 lg:w-14"
      />
      <Image src={Light} alt="Light" className="absolute right-0" />
      <section
        id="about"
        className="z-20 flex h-[90vh] w-full items-start justify-center bg-gradient-to-b from-[#589fc0] to-[#51ADD7] md:h-[130vh] lg:h-[95vh]"
      >
